...
export const PRICING: Record<BusinessType, PricingTable> = {
  corporate: {
    ...
    annualTiers: [
      { max: 100_000_000, fee: 800_000 },
      { max: 300_000_000, fee: 1_200_000 },
      { max: 600_000_000, fee: 1_700_000 },
      { max: 1_000_000_000, fee: 2_400_000 },
      { max: 1_500_000_000, fee: 3_000_000 },
      { max: 2_000_000_000, fee: 3_500_000 },
      { max: 3_000_000_000, fee: 4_200_000 },
      { max: 4_000_000_000, fee: 5_000_000 },
      { max: 5_000_000_000, fee: 5_500_000 },
    ],
    included: [
  ...
  sole: {
    ...
    annualTiers: [
      ...
      { max: 600_000_000, fee: 1_400_000 },
      { max: 1_000_000_000, fee: 2_000_000 },
      { max: 1_500_000_000, fee: 2_500_000 },
