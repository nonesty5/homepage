...
export const services: Service[] = [
  {
    ...
    title: "세무 기장",
    description:
      "결산 지연과 기장 누락을 줄이기 위해 월별 장부 기준, 자료 요청 루틴, 보고 체계를 정리합니다. 대표는 매달 바로 확인할 수 있는 숫자와 신고 일정 기준을 받습니다.",
    cta: "기장 정상화 방식 보기",
    icon: "ledger",
    details: [
  ...
  },
  {
    ...
    title: "세무 조정",
    description:
      "신고 시즌마다 임시로 맞추는 방식이 아니라, 조정 항목과 근거를 문서화해 법인세 신고의 완성도를 높입니다. 공제 · 감면 적용 여부와 소명 가능성을 함께 검토합니다.",
    cta: "세무조정 검토 범위 보기",
    icon: "calculator",
    details: [
      "법인세 · 종합소득세 세무조정 검토",
  ...
  },
  {
    ...
    title: "세무 자문",
    description:
      "지분 이동, 자산 이전, 승계, 특수관계자 거래처럼 결정 전에 세금을 먼저 계산해야 하는 이슈를 다룹니다. 시나리오별 세부담과 실행 순서를 비교해 대표가 선택할 수 있게 정리합니다.",
    cta: "세무 자문 산출물 보기",
    icon: "shield",
    details: [
      "법인 · 개인 세부담 시뮬레이션",
  ...
  },
  {
    ...
    title: "기업가치평가",
    description:
      "비상장주식, 투자유치, 승계, 합병 비율 판단에 필요한 평가 기준과 가정을 숫자로 정리합니다. 세법 기준과 거래 기준을 구분해 설명 가능한 평가 보고서를 만듭니다.",
    cta: "평가 방법론 보기",
    icon: "scale",
    details: [
  ...
  },
  {
    ...
    title: "M&A · IPO 자문",
    description:
      "매수 · 매도 실사에서 우발부채, 정상화 조정, 구조상 세무 비효율을 찾아 거래 판단에 필요한 숫자를 정리합니다. 딜 전에 확인할 항목과 협상 쟁점을 문서화합니다.",
    cta: "거래 자문 프로세스 보기",
    icon: "handshake",
    details: [
  ...
  },
  {
    ...
    title: "회계감사 · 회계자문",
    description:
      "감사 대응은 자료 제출이 아니라 기준 정리입니다. 감사인이 확인할 회계처리, 결산 자료, 내부통제 이슈를 미리 점검해 반복 질의를 줄입니다.",
    cta: "감사 대응 방식 보기",
    icon: "clipboard",
    details: [
...
export const members: Member[] = [
  {
    ...
    description:
      "Big4 회계법인과 IB에서 기장, 세무조정, 가치평가, 거래 자문이 실제 의사결정에 어떻게 연결되는지 다뤘습니다. 지금은 대표가 바로 써야 하는 월별 숫자, 신고 검토 메모, 의사결정 비교표를 직접 검토합니다.",
    credentials: [
      "공인회계사 (KICPA)",
      "성균관대학교 경영학과 졸업",
...
export const personas: Persona[] = [
  {
    ...
    description:
      "설립 직후에는 신고 일정, 증빙 수집, 비용 처리 기준이 동시에 비어 있습니다. 초기에 운영 기준을 잡아두면 이후 기장과 조정이 훨씬 덜 흔들립니다.",
    bottlenecks: [
      "부가세 · 원천세 일정과 자료 제출 방식이 정리되지 않음",
      "대표 급여, 비용 처리, 법인카드 사용 기준이 없음",
      "초기 장부가 뒤엉키기 전에 기장 기준을 잡아야 함",
    ],
    outputs: [
      "월별 자료 요청 리스트와 마감 일정표",
      "기본 계정 처리 기준 메모",
      "첫 신고까지 이어지는 기장 운영 체계",
    ],
  ...
  },
  {
    ...
    description:
      "거래와 인력이 늘면 장부를 맞추는 것만으로는 부족합니다. 월별 보고, 세무조정, 리스크 점검이 함께 돌아가야 대표가 숫자를 믿고 결정할 수 있습니다.",
    bottlenecks: [
    ...
    outputs: [
      "월별 재무 리포트와 주요 변동 정리",
      "세무조정 검토 메모와 신고 일정 기준",
      "리스크 항목 우선순위와 보완 체크리스트",
    ],
    fitServices: ["tax-bookkeeping", "tax-adjustment", "tax-advisory"],
  },
  {
    ...
    description:
      "지분 이동, 승계, 매각 검토 같은 큰 결정은 실행 전에 세금과 구조를 먼저 비교해야 합니다. 기존 기장 데이터와 자문이 같은 흐름으로 연결돼야 판단이 빨라집니다.",
    bottlenecks: [
